...
[the "How to set up the project locally" section](#how-to-set-up-the-project-locally) >>
step 2.
).
...
- remove `axios` from the frontend sub-project's dependencies,
  ...
  in the React Mega-Tutorial by Miguel Grinberg](https://blog.miguelgrinberg.com/post/the-react-mega-tutorial-chapter-5-connecting-to-a-back-end) as well as [this comment](https://github.com/axios/axios/issues/5026#issuecomment-1666588688)
