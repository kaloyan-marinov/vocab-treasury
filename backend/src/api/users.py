...
def send_email_requesting_that_account_should_be_confirmed(user):
    # TODO: (2023/03/06, 06:00)
    #       (a) replace `token_serializer_for_password_resets`
    #           with a newly-created `token_serializer_for_account_confirmation`;
    #       (b) add a "purpose" key to each token generated by the backend application;
